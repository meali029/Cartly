...
const Footer = () => {
  ...
  return (
    ...
    >
        ...
        <div
          className="absolute bottom-0 left-0 right-0 w-full flex justify-center text-[19vw] sm:text-[17vw] md:text-[14vw] lg:text-[11vw] xl:text-[9vw] 2xl:text-[8vw] font-extrabold tracking-widest px-0"
          style={{
